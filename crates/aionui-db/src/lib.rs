...
pub use repository::{
    ...
    ProvisionExternalIdentityParams, ProvisionExternalIdentityResult, RotateAuthCredentialsParams,
    RotateCoreAuthSessionParams, RotateCoreAuthSessionResult, SaveRuntimeStateParams, SidebarConversationThin,
    ...
    SqliteCoreAuthSessionRepository, SqliteCronRepository, SqliteExternalIdentityRepository,
    SqliteFeedbackDiagnosticsRepository, SqliteGeaResourceRepository, SqliteInteractionRequestRepository,
    SqliteMcpServerRepository, SqliteNotificationRepository, SqliteOAuthTokenRepository, SqliteProjectStore,
