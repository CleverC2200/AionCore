...
pub use repository::{
    ...
    IClientPreferenceRepository, IConversationRepository, ICronRepository, IExternalIdentityRepository,
    ...
    IUserRepository, IVoiceConfigurationRepository, MoveOutcome, OrderItemRef, PageDirection, PersistedSessionState,
    PinOutcome, PinnedCursor, ProvisionExternalIdentityError, ProvisionExternalIdentityParams,
    ProvisionExternalIdentityResult, SaveRuntimeStateParams, SidebarConversationThin, SidebarProjectMeta,
    SidebarTeamThin, SqliteAcpSessionRepository, SqliteAgentMetadataRepository, SqliteApprovalReceiptRepository,
