...
pub use repository::{
    ActivityCursor, ArchiveScope, CreateAcpSessionParams, EnsureExternalIdentityParams, EnsureExternalIdentityResult,
    ...
    IApprovalReceiptRepository, IAssistantDefinitionRepository, IAssistantOverlayRepository,
