    ...
    fn descriptor_permissions_are_shared() {
        ...
        assert_eq!(
            ...
            vec![
                ...
                ("team_work_create".to_owned(), TeamToolPermission::AnyTeamAgent),
                ("team_work_list".to_owned(), TeamToolPermission::AnyTeamAgent),
                ("team_work_command".to_owned(), TeamToolPermission::AnyTeamAgent),
